...
namespace PoratlServices.Migrations
{
    ...
    [Migration("20231015171430_removedPwdInEmployer")]
    partial class removedPwdInEmployer
    {
            ...
            modelBuilder.Entity("DomainModel.Employer", b =>
                {
                    b.HasOne("DomainModel.User", "User")
                        .WithOne("Employer")
                        .HasForeignKey("DomainModel.Employer", "EMail")
                        .HasPrincipalKey("DomainModel.User", "EMail");
            ...
            modelBuilder.Entity("DomainModel.JobSeeker", b =>
                {
                    b.HasOne("DomainModel.User", "User")
                        .WithOne("JobSeeker")
                        .HasForeignKey("DomainModel.JobSeeker", "EMail")
                        .HasPrincipalKey("DomainModel.User", "EMail");
